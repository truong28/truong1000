...
<link rel="stylesheet" type="text/css" href="{{asset('public/fontend/css/sigup.css')}}"/>
<!-- /css -->
...
<div class="content-w3ls" style="background-image: url({{asset('public/fontend/images/login1.jpg')}})">
	
	
	<div class="content-agile2" style="padding-bottom: 10px">
		<h2 class="agileits1" > <a href="trang-chu">Tourguide website</a> </h2>
		<form action="{{URL::to('/kh_dangki')}}" method="post">
		{{ csrf_field() }}
		<?php
			...
			<div class="form-control agileinfo" s>	
				<input type="tel"  name="txtphone" placeholder="numberphone" id="phone" required="">
			</div>		
