...
<!-- css files -->
<link rel="stylesheet" type="text/css" href="{{asset('public/fontend/css/font1.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('public/fontend/css/1.css')}}">
<!-- /css files -->
			...
			<h1>Tourguide website</h1>
				...
				<!--form-stars-here-->
						<div class="form-w3-agile">
							...
							<h2>Đăng nhập</h2>
                            <hr width="70%"><br>
							<form action="{{URL::to('hdv_login')}}" method="post">
                              {{ csrf_field() }}
								...
								<p class="p-bottom-w3ls1">New User?<a class href="kh_dangki">  Register here</a></p>
								<div class="clear"></div>
