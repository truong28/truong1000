...
<body>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="our-link">
                        <ul>
                            ...
                            <li><a href="kh_dangnhap"><i class="fas fa-headset"></i> Đăng nhập</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
								<li><a href="{{URL::to('vung-mien/miền bắc')}}">Du lich mien Bắc</a></li>
    ...
    <div class="products-box">
        <div class="container">
          ...
          @foreach($showvung as $key=>$tour)
            <div class="row special-list" >
                <div class="col-lg-3 col-md-6 special-grid bulbs">
                    <div class="products-single fix"  >
                        <div class="box-img-hover" >
                            <div class="type-lb">
                                <p class="sale">{{$tour->tentour}}</p>
                            </div>
                           <img src="{{asset('public/fontend/images/'.$tour->image)}}" class="img-fluid" alt="Image">
                            <div class="mask-icon">
                                <ul>
                                    <li><a href="{{URL::to('chi-tiet-tour/'.$tour->idtour)}}" data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-eye">Xem chi tiết</i></a></li>
                                 
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-12" >
                            <b>Tên tour:{{$tour->tentour}}</b></br>
                            <b>Giá:{{$tour->giatour}}</b>
                        </div>
                    </div>
